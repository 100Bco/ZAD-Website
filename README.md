...
- Trang About: carousel ảnh trượt ngang có chấm điều hướng (tự chuyển ảnh cho tới khi người xem bấm chấm hoặc vuốt, sau đó đứng yên ở ảnh đã chọn); 3 vòng tròn thành tựu (giữ đúng tỉ lệ Figma 1440x946, tự thu nhỏ cho vừa một màn hình trên máy có màn hình thấp, chỉnh ở biến `--stage-w` của `.achievements`) hiện lần lượt từ nhỏ đến lớn, cách nhau 0,7 giây, kèm số đếm lên; thẻ hệ sinh thái đổi sang xanh nhạt khi rê chuột; dòng chữ "Tư duy thiết kế..." chạy ngang, đọc xuôi từ trái sang phải.
